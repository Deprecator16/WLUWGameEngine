...
void WLUW::WTexture::render(SDL_Renderer* renderer, int x, int y, float scale, SDL_Rect* clip, float angle, SDL_Point* center, SDL_RendererFlip flip)
{
...
void WLUW::WTexture::renderToRect(SDL_Renderer* renderer, SDL_Rect* dstrect, SDL_Rect* clip, float angle, SDL_Point* center, SDL_RendererFlip flip)
{
    //Render to screen
