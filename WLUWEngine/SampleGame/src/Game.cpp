 ...
 */
bool compareCollisionData(const Collision& a, const Collision& b)
{
 ...
 */
Collision getCollisionData(Hitbox* softBox, Hitbox* hardBox, unsigned int hardBoxId, double deltaTime)
{
